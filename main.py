...
def runTexture(img_list, alpha):
    ...
    diff3 = cv2.circle(diff3, coor, 6, color, 1)
...
if __name__ == "__main__":
    ...
    out_dir = os.path.join("videos", "out_candle")
...
#     print("Reading images.")
#     images = readImages(image_dir)
#     video_volume = textures.videoVolume(images)
#     print(video_volume.shape)
#
#     ssd_diff = textures.computeSimilarityMetric(video_volume)
#     print(ssd_diff)
#
#     transition_diff = textures.transitionDifference(ssd_diff)
#     idxs = textures.findBiggestLoop(transition_diff, 1.0)
#     print("Loop bounds: {}".format(idxs))
#     list_img = textures.synthesizeLoop(video_volume, idxs[0], idxs[1])
#
#     print('list, ', len(list_img))